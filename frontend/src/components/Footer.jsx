    ...
    <div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-xl font-bold mb-4">FitPlan</h3>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#" className="text-gray-400 hover:text-white transition">Plans</a></li>
            ...
            <div>
              ...
              <p className="text-gray-400 mb-4">Subscribe to get fitness tips and updates</p>
              <div className="flex">
                <input 
                  type="email" 
                ...
                />
                <button className="bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded-r transition">
                  Subscribe
                </button>
              </div>
            </div>
